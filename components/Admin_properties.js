...
function handleTokenExpiry(status,refreshToken){
  ...
  const approve = async(e) => {
    ...
    const endpoint = `http://34.218.112.35/admin/judge/property/${property_id}?decision=approve`
  ...
  const reject = async(e) => {
    ...
    //http://baseUrl/admin/judge/property/{property_id}?decision={approve/reject}
    const endpoint = `http://34.218.112.35/admin/judge/property/${property_id}?decision=reject`
